...
const PdfColor blue = PdfColor.fromInt(0xff1976d2);
const PdfColor lightblue = PdfColor.fromInt(0xff90caf9);
const PdfColor qrcolor = PdfColor.fromInt(0xff03291c);
const PdfColor grey300 = PdfColor.fromInt(0xffe0e0e0);
const PdfColor grey400 = PdfColor.fromInt(0xffbdbdbd);
const PdfColor grey500 = PdfColor.fromInt(0xff9e9e9e);
const PdfColor grey600 = PdfColor.fromInt(0xff757575);
const PdfColor grey800 = PdfColor.fromInt(0xff424242);
