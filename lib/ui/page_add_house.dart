                        ...
                        children: <Widget>[
                          new Align(
                            ...
                            child: Container(
                              ...
                              child:Icon( Icons.my_location,size: 30.0,color: Colors.blue[400],),
                            ),
                          ),
                          Expanded(
                            child: Align(
                  ...
                  child:Container(
                    ...
                    child: Column(        
                      ...
                      children: <Widget>[
                        ...
                        Row(         //DEPOSIT AMOUNT RENT STATUS 
                          children: <Widget>[
                            Expanded(
                          child: Align(
                              alignment: Alignment.centerLeft,
                        ...
                        Row(            //DEPOSIT AMOUNT STATUS ENTRY
                          children: <Widget>[
                            Expanded(                      
                              child: Container(
                                width: MediaQuery.of(context).size.width,
      ...
      children: <Widget>[
        Padding(
          ...
          child: ChoiceChip(
            ...
            label: Text(
              ...
              style: TextStyle(
                color:
                  (_value == 1) ? Colors.grey.shade200 : Colors.black87,
              ),
            ),
        ...
        Padding(
            ...
            label: Text(
              ...
              style: TextStyle(
                color:
                  (_value == 2) ? Colors.grey.shade200 : Colors.black87,
              ),
            ),
            selected: _value == 2,
            onSelected: (bool selected) {
        ...
        Padding(
          ...
          child: ChoiceChip(
            ...
            label: Text(
              ...
              style: TextStyle(
                  color:
                    (_value == 3) ? Colors.grey.shade200 : Colors.black87,
                ),
            ),
            selected: _value == 3,
            onSelected: (bool selected) {
        ...
        Padding(
          ...
          label: Text(
            ...
            style: TextStyle(
                color:
                  (_value == 4) ? Colors.grey.shade200 : Colors.black87,
              ),
          ),
          selected: _value == 4,
          onSelected: (bool selected) {
    ...
    Iterable<Widget> get actorWidgets sync* {
      for (ActorFilterEntry actor in _cast) {
        yield Padding(
          ...
          child: FilterChip(
            label: Text(actor.name,style: new TextStyle(fontSize: 11.0),),
            ...
            Container(
              child: Row(
                children: <Widget>[
                  ...
                  Text('Fully Furnished',style: TextStyle(fontSize: 18.0),),
                ],
              ),
            ),
            Container(
              child: Row(
                children: <Widget>[
                  ...
                  Text('Half Furnished',style: TextStyle(fontSize: 18.0),),
                ],
              ),
            ),
            Container(
              child: Row(
                children: <Widget>[
                  ...
                  Text('Not Furnished',style: TextStyle(fontSize: 18.0),),
                ],
              ),
            ),
          ],
                  ...
                  child:Container(
                    ...
                    child: Column(        
                      ...
                      children: <Widget>[
                        ...
                        Container(              //ABOUT PRPOERTY DETAILS
...
void createRecord(context) async {      
      var address = {'locality':_locality, 'city':_city,'state':_state,'society':_address,'pincode':_pincod,'houseNo':_hono};
      var overview = {'bathroom':_bath, 'room':_beds,'furnishingStatus':_farnistatus,'propertyType':_propert,'preferedType':_preferedType};
